...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{001011} \par
	\smallbreak
	\makebox[3.5cm][l]{Syntax:} \texttt{CEILING, rd, rs} \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{001100} \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{001101} \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{001110} \par
	\smallbreak
	\makebox[3.5cm][l]{Syntax:} \texttt{MIN, rd, rs1, rs2} \par
	\smallbreak
	\makebox[3.5cm][l]{Purpose:} Find the smallest value between rs1 and rs2 and store it \par
	\makebox[3.5cm][l]{  } in rd. \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{001111} \par
	\smallbreak
	\makebox[3.5cm][l]{Syntax:} \texttt{MAX, rd, rs1, rs2} \par
	\smallbreak
	\makebox[3.5cm][l]{Purpose:} Find the largest value between rs1 and rs2 and store it \par
	\makebox[3.5cm][l]{  } in rd. \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{010000} \par
	\smallbreak
	\makebox[3.5cm][l]{Syntax:} \texttt{POW, rd, rs1, \#<integer-value>} \par
	\smallbreak
	\makebox[3.5cm][l]{Purpose:} Find rs1 raised to an integer value and store it \par
	\makebox[3.5cm][l]{  } in rd. \par
	\smallbreak
	\makebox[3.5cm][l]{Operation:} rd $\leftarrow$ $rs1^{integer-value}$ \par
	\smallbreak
	\makebox[3.5cm][l]{Condition Codes:} \begin{tabular}{lll} N \quad & Z \quad & V \\ \hline x & - & x \\ \end{tabular}
}
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{010001} \par
	\smallbreak
	\makebox[3.5cm][l]{Syntax:} \texttt{EXP, rd, rs} \par
	\smallbreak
	\makebox[3.5cm][l]{Purpose:} Find e raised to the value in rs and store it \par
	\makebox[3.5cm][l]{  } in rd. \par
	\smallbreak
	\makebox[3.5cm][l]{Operation:} rd $\leftarrow$ $e^{rs}$ \par
	\smallbreak
	\makebox[3.5cm][l]{Condition Codes:} \begin{tabular}{lll} N \quad & Z \quad & V \\ \hline x & - & x \\ \end{tabular}
}
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{010010} \par
	\smallbreak
	\makebox[3.5cm][l]{Syntax:} \texttt{SQRT, rd, rs} \par
	\smallbreak
	\makebox[3.5cm][l]{Purpose:} Find the square root of the value in rs and store the result \par
	\makebox[3.5cm][l]{  } in rd. \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{010011} \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{010100} \par
	\smallbreak
...
{\large
	\makebox[3.5cm][l]{Opcode:} \texttt{010101} \par
	\smallbreak
